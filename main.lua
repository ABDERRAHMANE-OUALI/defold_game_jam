...
Boss.new = function() 
  local self = _hx_new(Boss.prototype)
  Boss.super(self)
  return self
end
Boss.super = function(self) 
  __defold_support_Script.super(self);
end
Boss.prototype = _hx_e();
Boss.prototype.init = function(self,_) 
  _G.msg.post(".", __defold_GoMessages.acquire_input_focus);
end
Boss.__super__ = __defold_support_Script
setmetatable(Boss.prototype,{__index=__defold_support_Script.prototype})
...
__defold_support_Init.init = function(exports) 
  ...
  local script = Boss.new();
  exports.Boss_init = function(_) 
    script:init(_);
  end;
end
